...
func TestGetSchemaPrompt(t *testing.T) {
	t.Run("Chinese", func(t *testing.T) {
		prompt := GetSchemaPrompt(LangChinese, 0.9)
	...
	t.Run("English", func(t *testing.T) {
		prompt := GetSchemaPrompt(LangEnglish, 0.9)
	...
	t.Run("Consistency", func(t *testing.T) {
		promptZH := GetSchemaPrompt(LangChinese, 0.9)
		promptEN := GetSchemaPrompt(LangEnglish, 0.9)
...
func BenchmarkGetSchemaPrompt(b *testing.B) {
	b.Run("Chinese", func(b *testing.B) {
		for i := 0; i < b.N; i++ {
			_ = GetSchemaPrompt(LangChinese, 0.9)
		}
	})

	b.Run("English", func(b *testing.B) {
		for i := 0; i < b.N; i++ {
			_ = GetSchemaPrompt(LangEnglish, 0.9)
		}
	})
}
